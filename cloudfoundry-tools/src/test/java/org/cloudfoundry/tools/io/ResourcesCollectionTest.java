...
import org.cloudfoundry.tools.io.ResourceFilter;
import org.cloudfoundry.tools.io.ResourceFilterContext;
import org.cloudfoundry.tools.io.ResourceOperation;
import org.cloudfoundry.tools.io.ResourcesCollection;
...
public class ResourcesCollectionTest {
	...
	public void shouldIterateCollection() throws Exception {
		ResourcesCollection<Resource> collection = new ResourcesCollection<Resource>(this.source, Arrays.asList(
	...
	public void shouldSupportFiltering() throws Exception {
		...
		Iterator<File> actual = collection.include(filterOn(a), filterOn(c), filterOn(e)).exclude(filterOn(c))
				.iterator();
